...
module Draper
  # Provides shourtcuts to decorate objects directly, so you can do
  # `@product.decorate` instead of `ProductDecorator.new(@product)`.
  #
  # This module is included by default into 'ActiveRecord::Base' and
  # 'Mongoid::Document', but if you're using another ORM, or want to decorate
  ...
  module Decoratable
    ...
    # (see ClessMethods#decoratot_class)
    def decorator_class
    ...
    module ClassMethods
      ...
      # Infers the decorator class to be used by {Decoratable#decorate}
      # (e.g. 'Product' maps to 'ProductDecorator')
      #
      ...
      # Compares withpossibly-decorated objects.
      #
      # @return [Boolean]
      def ===(other)
